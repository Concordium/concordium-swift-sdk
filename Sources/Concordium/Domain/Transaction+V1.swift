...
public enum SponsoredTransactionValidator {
    ...
    public static func validatePLTTransferBalance(
        ...
        if case .updatePLT(_, let operation) = payload {
            if case .transfer(let transferPayload) = operation {
...
public struct SponsoredTransactionBuilder {
