...
final class CIS0Test: XCTestCase {
    func testSerializeSupportsParam() throws {
        ...
        let data = param.contractSerialize()
        let expected = try Data(hex: "0200054349532d30054349532d32")
        XCTAssertEqual(data, expected)
    }

    func testDeserializeSupportsResponse() throws {
        let value = try CIS0.SupportsResponse.contractDeserialize(Data(hex: "0300010002027b00000000000000000000000000000041010000000000000c00000000000000")).elements
