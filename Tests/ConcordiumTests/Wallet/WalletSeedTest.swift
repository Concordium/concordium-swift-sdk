...
final class WalletSeedTest: XCTestCase {
    ...
    func testMainnetIdentitySignatureBlindingRandomness() throws {
        let seed = try WalletSeed(seedHex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.signatureBlindingRandomness(
    ...
    func testMainnetAccountCredentialId() throws {
        ...
        XCTAssertEqual(
            try seed.id(
                ...
                commitmentKey: Data(hex: "b14cbfe44a02c6b1f78711176d5f437295367aa4f2a8c2551ee10d25a03adc69d61a332a058971919dad7312e1fc94c5a8d45e64b6f917c540eee16c970c3d4b7f3caf48a7746284878e2ace21c82ea44bf84609834625be1f309988ac523fac")
            ).hex,
    ...
    func testMainnetAccountCredentialAttributeCommitmentRandomness() throws {
        let seed = try WalletSeed(seedHex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.attributeCommitmentRandomness(
                accountCredentialIndexes: AccountCredentialSeedIndexes(
