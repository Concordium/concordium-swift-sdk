...
final class ConcordiumWalletSeedTest: XCTestCase {
    ...
    func testMainnetSigningKey() throws {
        ...
        XCTAssertEqual(
            try seed.getSigningKey(of: Credential(identityProviderIndex: 0, identityIndex: 55, credentialCounter: 7)),
    ...
    func testMainnetPublicKey() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getPublicKey(of: Credential(identityProviderIndex: 1, identityIndex: 341, credentialCounter: 9)),
    ...
    func testMainnetPublicAndSigningKeyMetch() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        let privateKey = try seed.getSigningKey(of: Credential(identityProviderIndex: 0, identityIndex: 0, credentialCounter: 0))
        let publicKey = try seed.getPublicKey(of: Credential(identityProviderIndex: 0, identityIndex: 0, credentialCounter: 0))
    ...
    func testMainnetCredId() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getCredentialId(of: Credential(identityProviderIndex: 10, identityIndex: 50, credentialCounter: 5), commitmentKey: "b14cbfe44a02c6b1f78711176d5f437295367aa4f2a8c2551ee10d25a03adc69d61a332a058971919dad7312e1fc94c5a8d45e64b6f917c540eee16c970c3d4b7f3caf48a7746284878e2ace21c82ea44bf84609834625be1f309988ac523fac"),
    ...
    func testMainnetAttributeCommitmentRandomness() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getAttributeCommitmentRandomness(of: Credential(identityProviderIndex: 5, identityIndex: 0, credentialCounter: 4), attribute: 0),
