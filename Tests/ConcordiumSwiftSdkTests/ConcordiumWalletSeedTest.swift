...
final class ConcordiumWalletSeedTest: XCTestCase {
    ...
    func testMainnetSigningKey() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getSigningKey(of: ConcordiumCredential(identityProviderIndex: 0, identityIndex: 55, credentialCounter: 7)),
    ...
    func testMainnetPublicKey() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getPublicKey(of: ConcordiumCredential(identityProviderIndex: 1, identityIndex: 341, credentialCounter: 9)),
    ...
    func testMainnetPublicAndSigningKeyMetch() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        let privateKey = try seed.getSigningKey(of: ConcordiumCredential(identityProviderIndex: 0, identityIndex: 0, credentialCounter: 0))
        let publicKey = try seed.getPublicKey(of: ConcordiumCredential(identityProviderIndex: 0, identityIndex: 0, credentialCounter: 0))
    ...
    func testMainnetIdCredSec() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getIdCredSec(identityProviderIndex: 2, identityIndex: 115),
    ...
    func testMainnetPrfKey() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getPrfKey(identityProviderIndex: 3, identityIndex: 35),
    ...
    func testMainnetCredId() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getCredentialId(of: ConcordiumCredential(identityProviderIndex: 10, identityIndex: 50, credentialCounter: 5), commitmentKey: "b14cbfe44a02c6b1f78711176d5f437295367aa4f2a8c2551ee10d25a03adc69d61a332a058971919dad7312e1fc94c5a8d45e64b6f917c540eee16c970c3d4b7f3caf48a7746284878e2ace21c82ea44bf84609834625be1f309988ac523fac"),
    ...
    func testMainnetBlindingRandomness() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getSignatureBlindingRandomness(identityProviderIndex: 4, identityIndex: 5713),
    ...
    func testMainnetAttributeCommitmentRandomness() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getAttributeCommitmentRandomness(of: ConcordiumCredential(identityProviderIndex: 5, identityIndex: 0, credentialCounter: 4), attribute: 0),
    ...
    func testMainnetVerifiableCredentialSigningKey() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getVerifiableCredentialSigningKey(issuerIndex: 1, issuerSubindex: 2, verifiableCredentialIndex: 1),
    ...
    func testMainnetVerifiableCredentialPublicKey() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.getVerifiableCredentialPublicKey(issuerIndex: 3, issuerSubindex: 1232, verifiableCredentialIndex: 341),
    ...
    func testTestnetVerifiableCredentialSigningKey() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .testnet)
        XCTAssertEqual(
            try seed.getVerifiableCredentialSigningKey(issuerIndex: 13, issuerSubindex: 0, verifiableCredentialIndex: 1),
    ...
    func testTestnetVerifiableCredentialPublicKey() throws {
        let seed = ConcordiumWalletSeed(hex: TEST_SEED, network: .testnet)
        XCTAssertEqual(
            try seed.getVerifiableCredentialPublicKey(issuerIndex: 17, issuerSubindex: 0, verifiableCredentialIndex: 341),
