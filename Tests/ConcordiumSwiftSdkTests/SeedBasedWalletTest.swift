...
final class SeedBasedWalletTest: XCTestCase {
    ...
    func testMainnetSigningKey() throws {
        ...
        XCTAssertEqual(
            try seed.signingKey(of: IdentityCredential(identity: Identity(providerIndex: 0, index: 55), counter: 7)),
    ...
    func testMainnetPublicKey() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.publicKey(of: IdentityCredential(identity: Identity(providerIndex: 1, index: 341), counter: 9)),
    ...
    func testMainnetPublicAndSigningKeyMetch() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        let privateKey = try seed.signingKey(of: IdentityCredential(identity: Identity(providerIndex: 0, index: 0), counter: 0))
        let publicKey = try seed.publicKey(of: IdentityCredential(identity: Identity(providerIndex: 0, index: 0), counter: 0))
    ...
    func testMainnetIdCredSec() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.credSec(of: Identity(providerIndex: 2, index: 115)),
    ...
    func testMainnetPrfKey() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.prfKey(of: Identity(providerIndex: 3, index: 35)),
    ...
    func testMainnetCredId() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.id(of: IdentityCredential(identity: Identity(providerIndex: 10, index: 50), counter: 5), commitmentKey: "b14cbfe44a02c6b1f78711176d5f437295367aa4f2a8c2551ee10d25a03adc69d61a332a058971919dad7312e1fc94c5a8d45e64b6f917c540eee16c970c3d4b7f3caf48a7746284878e2ace21c82ea44bf84609834625be1f309988ac523fac"),
    ...
    func testMainnetBlindingRandomness() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.signatureBlindingRandomness(of: Identity(providerIndex: 4, index: 5713)),
    ...
    func testMainnetAttributeCommitmentRandomness() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.attributeCommitmentRandomness(of: IdentityCredential(identity: Identity(providerIndex: 5, index: 0), counter: 4), attribute: 0),
    ...
    func testTestnetCredIdMatchesCredDeployment() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .testnet)
        XCTAssertEqual(
            try seed.id(of: IdentityCredential(identity: Identity(providerIndex: 0, index: 0), counter: 1), commitmentKey: "b14cbfe44a02c6b1f78711176d5f437295367aa4f2a8c2551ee10d25a03adc69d61a332a058971919dad7312e1fc94c5a8d45e64b6f917c540eee16c970c3d4b7f3caf48a7746284878e2ace21c82ea44bf84609834625be1f309988ac523fac"),
    ...
    func testMainnetVerifiableCredentialSigningKey() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.signingKey(of: VerifiableCredential(issuer: Issuer(index: 1, subindex: 2), index: 1)),
    ...
    func testMainnetVerifiableCredentialPublicKey() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .mainnet)
        XCTAssertEqual(
            try seed.publicKey(of: VerifiableCredential(issuer: Issuer(index: 3, subindex: 1232), index: 341)),
    ...
    func testTestnetVerifiableCredentialSigningKey() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .testnet)
        XCTAssertEqual(
            try seed.signingKey(of: VerifiableCredential(issuer: Issuer(index: 13, subindex: 0), index: 1)),
    ...
    func testTestnetVerifiableCredentialPublicKey() throws {
        let seed = WalletSeed(hex: TEST_SEED, network: .testnet)
        XCTAssertEqual(
            try seed.publicKey(of: VerifiableCredential(issuer: Issuer(index: 17, subindex: 0), index: 341)),
